							...
							<div class="col-xl-3 col-md-6">
								<div class="card bg-c-yellow update-card">
									...
									<div class="card-footer">
										<p class="text-white m-b-0"><i class="feather icon-clock text-white f-14 m-r-10"></i>Ver mas</p>
									</div>
								</div>
							</div>
							<div class="col-xl-3 col-md-6">
									...
									<div class="card-block">
										<div class="row m-b-25">
											<div class="col-auto p-r-0">
												<div class="u-img">
													<img src="{{ asset('src/assets/images/breadcrumb-bg.jpg') }}" alt="user image" class="img-radius cover-img">
													<img src="{{ asset('src/assets/images/avatar-2.jpg') }}" alt="user image" class="img-radius profile-img">
												</div>
											</div>
											<div class="col">
							...
							<div class="col-xl-3 col-md-6">
								<div class="card wather-card">
									<div class="nature-card">
										<img src="{{ asset('src/assets/images/widget/wathernature.png') }}" alt="whether image" class="img-fluid main-img">
										<img src="{{ asset('src/assets/images/widget/watherstar1.png') }}" alt="whether image" class="snow1">
										<img src="{{ asset('src/assets/images/widget/watherstar2.png') }}" alt="whether image" class="snow2">
										<img src="{{ asset('src/assets/images/widget/watherbottom.png') }}" alt="whether image" class="bottom-img">
